...
id/specialization/search/all),
 
PUT
 
(update/verify/availability),
...
findAvailableByProviderAndDate(),
 
findByDateBetween(),
 
countAvailableByProviderId(),
...
id/patient/provider/date/upcoming),
 
PUT
 
(cancel/reschedule/complete/status),
...
provider/patient/appointment/all),
...
(BOOKING/REMINDER/CANCELLATION/PAYME 
NT/FOLLOWUP),
...
appointment/patient/provider/id/followUps),
 
PUT
 
(update/attachDocument),
